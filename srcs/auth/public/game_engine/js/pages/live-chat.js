        ...
        <div class="chat-container" id="chatContainer">
            <div class="left-panel">
                ...
                <div class="friends-tabs">
                    <img id="friendsButton" class="active" src="game_engine/images/friends.png" alt="Friends">
                    <div id="friendRequestsButtonContainer" style="position: relative; display: inline-block;">
                        <img id="friendRequestsButton" src="game_engine/images/add-friend.png" alt="Requests">
                    ...
                    <img id="blockedUsersButton" src="game_engine/images/block-user.png" alt="Blocked">
                </div>
