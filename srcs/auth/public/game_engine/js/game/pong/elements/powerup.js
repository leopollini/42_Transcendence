export class Powerup {
    ...
    loadImages() {
        ...
        types.forEach(type => {
            ...
            this.sprites[type].src = `game_engine/images/${type}_spritesheet.png`; // Assicurati che il percorso sia corretto
    ...
    render() {
        ...
        if (this.sprite.complete) {  // Controlla che l'immagine sia caricata
            ...
            console.warn(`Sprite non ancora caricata: game_engine/images/${this.type}_spritesheet.png`);
        }
    }
